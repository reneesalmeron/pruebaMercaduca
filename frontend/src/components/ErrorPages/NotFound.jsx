...
import notFoundImage from "../../images/búho_404.png";
      ...
      <div className="max-w-lg w-full text-center">
        ...
        <div className="space-y-4 mb-8">
          <p className="text-gray-600">
            La página que estás buscando no existe o no se pudo encontrar.
          </p>
          <p className="text-sm text-gray-500">
            Verifica la URL o navega a través de nuestros enlaces.
          </p>
        </div>
        ...
        <div className="mt-8 p-4 bg-white rounded-lg border border-blue-200">
          <p className="text-xs text-gray-500">
            Posibles causas: URL incorrecta, página movida o eliminada.
          </p>
        </div>
      </div>
    </div>
